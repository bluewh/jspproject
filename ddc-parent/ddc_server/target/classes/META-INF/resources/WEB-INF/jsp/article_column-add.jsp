...
<div class="page-container">
    <form action="/programa/insert" method="post" class="form form-horizontal" id="form-category-add">
            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <input type="text" class="input-text" value="" placeholder="" id="" name="programa_name">
                    </div>
                    <div class="col-3">
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
						...
						<select name="type_select" class="select" >
