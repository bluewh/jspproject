...
<div class="page-container">
	<div class="text-c">
		<input type="text" class="input-text" style="width:250px" placeholder="栏目名称" id="keywords" name="keywords"/>
	...
	<form class="layui-form" action="">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="name" value="{{ d.name || '' }}" lay-verify="required"
					   placeholder="请输入栏目名" autocomplete="off" class="layui-input">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<input type="radio" name="type" value="文章" title="文章"
					   {{# if(d.type==="文章"){ }}
					   checked
					   {{# } }}
				/>

				<input type="radio" name="type" value="图片" title="图片"
					   {{# if(d.type==="图片"){ }}
					   checked
					   {{# } }}
				/>
...
<script type="text/html" id="toolbarDemo">
	<div class="layui-btn-container">
		...
		<a class="layui-btn layui-btn-sm" onclick="system_category_add('添加栏目','article_column-add',800)" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
	</div>
</script>
	...
	$(function () {
		layui.use(['table', 'laytpl', 'element', 'form'], function () {
					...
					table.render({
						...
						, toolbar: '#toolbarDemo'
						, height: 'full-220'
						, url: '/programa/list' //数据接口
						, page: true //开启分页
						, cols: [[ //表头
							{type: 'checkbox', fixed: 'left'}
							, {
								field: 'id', title: 'ID', width: '24%', sort: true, fixed: 'left', templet: function (d) {
									return d.id;//long 转Stirng
								}
							}
							, {field: 'name', title: '栏目名称', width: '24%'}
							, {
								field: 'type', title: '内容类型', width: '24%'
